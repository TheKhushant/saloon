...
import { approveOffer, createOffer, deleteOffer, fetchOffers, rejectOffer, updateOffer } from "./api";
...
export default function OffersPage() {
  ...
  const approveMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success("Offer approved - now visible to customers");
      invalidate();
    },
    onError: (e: unknown) => toast.error(extractMessage(e, "Failed to approve offer")),
  });
  ...
  const rejectMutation = useMutation({
    ...
    onError: (e: unknown) => toast.error(extractMessage(e, "Failed to reject offer")),
  });
    ...
    <>
      ...
      <OffersTable
        ...
        actions={{
          ...
          onApprove: (o) => approveMutation.mutate(o._id),
          onReject: (o) => rejectMutation.mutate(o._id),
        }}
      />

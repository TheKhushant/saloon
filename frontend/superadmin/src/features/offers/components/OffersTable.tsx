  ...
  const columns = useMemo<ColumnDef<Offer>[]>(
    () => [
      ...
      },
      {
        ...
        header: "Approval",
        cell: ({ row }) => (
          <Badge variant="outline" className={approvalBadgeClass[row.original.approvalStatus]}>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {o.approvalStatus !== "APPROVED" && (
                  <DropdownMenuItem onClick={() => actions.onApprove(o)}>
                    <Check className="mr-2 h-4 w-4" /> Approve
                  </DropdownMenuItem>
                )}
                {o.approvalStatus !== "REJECTED" && (
                  <DropdownMenuItem onClick={() => actions.onReject(o)}>

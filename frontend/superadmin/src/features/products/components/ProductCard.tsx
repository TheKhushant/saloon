import { MoreHorizontal, Pencil, Trash2, MapPin, AlertTriangle, PackagePlus, Star, Check, X } from "lucide-react";
...
import { approvalBadgeClass, approvalLabel } from "@/lib/approval";
    ...
    >
      ...
      <CardContent className="space-y-2 p-3">
        <div className="flex flex-wrap items-center gap-1">
          ...
          <Badge variant="outline" className={`text-[11px] font-normal ${approvalBadgeClass[product.approvalStatus]}`}>

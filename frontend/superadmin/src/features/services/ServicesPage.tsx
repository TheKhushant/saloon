...
import { approveService, createService, deleteService, fetchServices, rejectService, updateService } from "./api";
...
export default function ServicesPage() {
  ...
  const approveMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success("Service approved - now visible to customers");
      invalidate();
    },
    onError: (e: unknown) => toast.error(extractMessage(e, "Failed to approve service")),
  });

  const rejectMutation = useMutation({
    mutationFn: (id: string) => rejectService(id),
    onSuccess: () => {
      toast.success("Service rejected");
      invalidate();
    },
    onError: (e: unknown) => toast.error(extractMessage(e, "Failed to reject service")),
  });
    ...
    <>
      ...
      <ServicesTable
        ...
        actions={{
          ...
          onApprove: (s) => approveMutation.mutate(s._id),
          onReject: (s) => rejectMutation.mutate(s._id),
        }}
      />

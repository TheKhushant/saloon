...
export type TemplateAssignmentStatus = "assigned" | "pending";
...
export interface Template {
  ...
  assignments: TemplateAssignment[]; // per-branch assignment records
  suitableFor: string;
  budgetMin: number;
  budgetMax: number;
  setupDays: number;
...
export function getAssignedBranchIds(t: Template): string[] {
  return t.assignments.map((a) => a.branchId);
}

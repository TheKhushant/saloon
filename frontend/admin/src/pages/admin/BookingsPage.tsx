...
export default function BookingsPage() {
  ...
  const loadBookings = async () => {
    // No frontend-side branch filtering needed here: the backend already
    // scopes /api/admin/bookings to the logged-in admin's own branch
    // automatically (via the JWT's branchId claim), so whatever comes back
    // is already correct for a branch admin.

...
import {
  useDirection
} from "./chunk-LJH4NOXE.js";
import {
  Presence,
  useCallbackRef
} from "./chunk-DDLFKE7G.js";
import {
  composeEventHandlers,
  createContextScope,
  useLayoutEffect2
} from "./chunk-F734DAYG.js";
import {
  Primitive
} from "./chunk-A24MDAYK.js";
...
var ScrollArea = React2.forwardRef(
  __name2(function ScrollArea2(props, forwardedRef) {
    const {
      __scopeScrollArea,
      type = "hover",
      dir,
...
var ScrollAreaViewport = React2.forwardRef(
  ...
  __name2(function ScrollAreaViewport2(props, forwardedRef) {
...
var ScrollAreaViewportStyle = React2.memo(
  __name2(function ScrollAreaViewportStyle2({ nonce }) {
    return (0, import_jsx_runtime.jsx)(
      "style",
      {
...
var ScrollAreaScrollbar = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function ScrollAreaScrollbar2(props, forwardedRef) {
...
var ScrollAreaScrollbarHover = React2.forwardRef(__name2(function ScrollAreaScrollbarHover2(props, forwardedRef) {
  const { forceMount, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  ...
  React2.useEffect(() => {
    ...
    let hideTimer = 0;
    if (scrollArea) {
      const handlePointerEnter = __name2(() => {
        window.clearTimeout(hideTimer);
        setVisible(true);
      }, "handlePointerEnter");
      const handlePointerLeave = __name2(() => {
...
var ScrollAreaScrollbarScroll = React2.forwardRef(__name2(function ScrollAreaScrollbarScroll2(props, forwardedRef) {
  const { forceMount, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const isHorizontal = props.orientation === "horizontal";
...
var ScrollAreaScrollbarAuto = React2.forwardRef(__name2(function ScrollAreaScrollbarAuto2(props, forwardedRef) {
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const { forceMount, ...scrollbarProps } = props;
  const [visible, setVisible] = React2.useState(false);
  const isHorizontal = props.orientation === "horizontal";
...
var ScrollAreaScrollbarVisible = React2.forwardRef(__name2(function ScrollAreaScrollbarVisible2(props, forwardedRef) {
  ...
  const commonProps = {
    ...
    onThumbChange: __name2((thumb) => thumbRef.current = thumb, "onThumbChange"),
    onThumbPointerUp: __name2(() => pointerOffsetRef.current = 0, "onThumbPointerUp"),
    onThumbPointerDown: __name2((pointerPos) => pointerOffsetRef.current = pointerPos, "onThumbPointerDown")
  };
...
var ScrollAreaScrollbarX = React2.forwardRef(__name2(function ScrollAreaScrollbarX2(props, forwardedRef) {
...
var ScrollAreaScrollbarY = React2.forwardRef(__name2(function ScrollAreaScrollbarY2(props, forwardedRef) {
  const { sizes, onSizesChange, ...scrollbarProps } = props;
  const context = useScrollAreaContext(SCROLLBAR_NAME, props.__scopeScrollArea);
  const [computedStyle, setComputedStyle] = React2.useState();
  const ref = React2.useRef(null);
...
var ScrollAreaScrollbarImpl = React2.forwardRef(__name2(function ScrollAreaScrollbarImpl2(props, forwardedRef) {
  const {
    __scopeScrollArea,
    sizes,
    hasThumb,
  ...
  React2.useEffect(() => {
    const handleWheel = __name2((event) => {
...
var ScrollAreaThumb = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function ScrollAreaThumb2(props, forwardedRef) {
...
var ScrollAreaThumbImpl = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function ScrollAreaThumbImpl2(props, forwardedRef) {
...
var ScrollAreaCorner = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function ScrollAreaCorner2(props, forwardedRef) {
...
var ScrollAreaCornerImpl = React2.forwardRef(__name2(function ScrollAreaCornerImpl2(props, forwardedRef) {
...
var addUnlinkedScrollListener = __name2((node, handler = () => {
}) => {
  let prevPosition = { left: node.scrollLeft, top: node.scrollTop };
  let rAF = 0;
  __name2(function loop() {

...
const allServices = [
  ...serviceCategories.men,
  ...serviceCategories.women,
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-card rounded-2xl border border-border p-6 space-y-6">
                ...
                <div>
                  <label className="text-sm font-medium text-muted-foreground mb-2 block">Select Stylist (Optional)</label>
                  <div className="space-y-2">
                    {stylists.map((st) => (
                      <button
                        key={st.id}
                        onClick={() => setSelectedStylist(st.id === selectedStylist ? null : st.id)}

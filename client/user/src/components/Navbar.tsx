      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-heading text-xl font-bold text-foreground">BookSalon</span>
          </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 border-t border-border mt-2 pt-4 space-y-3">
            ...
            <div className="flex gap-3 pt-2">
              <Link to="/login" className="text-sm font-medium text-muted-foreground">Log in</Link>

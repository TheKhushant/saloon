    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="hidden lg:flex flex-col w-64 gradient-dark text-accent-foreground p-6">
        <Link to="/" className="flex items-center gap-2 mb-10">
          ...
          <span className="font-heading text-lg font-bold">Glam Aura</span>
        </Link>
        ...
        {tab === "reviews" && (
          <div>
            ...
            <div className="space-y-4">
              {[
                { id: 1, user: "Ryan J.", salon: "Glam Aura Barber Co.", rating: 5, comment: "Amazing experience!", date: "Mar 1, 2026" },
                { id: 2, user: "Mike C.", salon: "The Style Studio", rating: 4, comment: "Great service, will return.", date: "Feb 28, 2026" },
                { id: 3, user: "Ethan D.", salon: "Glow & Grit Grooming Spa", rating: 5, comment: "Best grooming spa in town!", date: "Feb 25, 2026" },
              ].map((r) => (
